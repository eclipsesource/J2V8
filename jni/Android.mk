...
#LOCAL_SRC_FILES := ../libv8_base.arm.a
#LOCAL_SRC_FILES := /data/jenkins/v8_3_26/out/android_$(TARGET_ARCH_ABI).release/obj.target/tools/gyp/libv8_base.$(TARGET_ARCH_ABI).a
LOCAL_SRC_FILES := /data/jenkins/v8/out/android_x64.release/obj.target/tools/gyp/libv8_libbase.a
include $(PREBUILT_STATIC_LIBRARY)
...
#LOCAL_SRC_FILES :=  ../support/android/libs/libv8_nosnapshot.arm.a
#LOCAL_SRC_FILES :=  ../libv8_nosnapshot.arm.a
LOCAL_SRC_FILES :=  /data/jenkins/v8/out/android_x64.release/obj.target/tools/gyp/libv8_libplatform.a
include $(PREBUILT_STATIC_LIBRARY)
...
LOCAL_SRC_FILES :=  /data/jenkins/v8/out/android_x64.release/obj.target/third_party/icu/libicuuc.a
include $(PREBUILT_STATIC_LIBRARY)
...
LOCAL_SRC_FILES :=  /data/jenkins/v8/out/android_x64.release/obj.target/third_party/icu/libicui18n.a
include $(PREBUILT_STATIC_LIBRARY)
...
#LOCAL_SRC_FILES :=  /data/jenkins/v8/out/android_x64.release/obj.target/tools/gyp/libicuuc.a
LOCAL_SRC_FILES :=  /data/jenkins/v8/out/android_x64.release/obj.target/third_party/icu/libicudata.a
include $(PREBUILT_STATIC_LIBRARY)
...
LOCAL_C_INCLUDES := /data/jenkins/v8/ 
LOCAL_CFLAGS += -Wall -Wno-unused-function -Wno-unused-variable -O3 -funroll-loops -ftree-vectorize -ffast-math -fpermissive -std=c++11
#LOCAL_STATIC_LIBRARIES := v8_base v8_nosnapshot libicui18n libicuuc libicudata
LOCAL_STATIC_LIBRARIES :=  v8_libplatform v8_base v8_nosnapshot v8_libbase libicui18n libicuuc libicudata 
