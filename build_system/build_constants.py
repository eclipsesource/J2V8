...
atomic_build_steps = [
    ...
    CLIStep(c.build_v8, "               Builds the V8 dependency artifacts that are later linked into the J2V8 native bridge code."),
...
advanced_steps = [
    ...
    CLIStep(c.build_j2v8, "            Run all build steps to build J2V8 (this does not try to build V8)\n" +
